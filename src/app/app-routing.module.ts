...
//route order MATTERS. Angular reads routes from top to bottom and when it fond a matching route, that is what it will go to. Thi is why you want your path to be as descriptive as possible!
